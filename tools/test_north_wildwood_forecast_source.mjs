// Ensure every UI selection consumes the scheduled product with one reduction.
...
for(const missing of [null,{}, {...forecast,scenarioVersion:undefined},
  ...
  {...forecast,scenarioAdjustmentFt:0}, {...forecast,scenarioVersion:'mean-anchors-min-minus-2in-max-p25-v3'}, {...forecast,scenarioForecasts:{}},
...
console.log('Passed reduced scenario selection, missing/old-source cases, repeated reads, and neutral display labels');
