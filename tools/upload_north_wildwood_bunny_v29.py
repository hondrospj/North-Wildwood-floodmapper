#!/usr/bin/env python3
"""Upload and verify the North Wildwood local-penalty v31 tree."""
...
CACHE_VERSION = "20260815-local-penalty-v31"
ATLAS_VERSION = "v31"
...
def main() -> None:
    ...
    report_path = Path("/tmp/north-wildwood-bunny-v31-upload.json")
