#!/usr/bin/env python3
"""Upload and verify the North Wildwood connected-feeder v30 tree."""
...
CACHE_VERSION = "20260815-connected-feeders-v30"
ATLAS_VERSION = "v30"
...
def main() -> None:
    ...
    report_path = Path("/tmp/north-wildwood-bunny-v30-upload.json")
