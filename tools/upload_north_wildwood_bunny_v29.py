#!/usr/bin/env python3
"""Upload and verify the North Wildwood road-feeder v32 tree."""
...
CACHE_VERSION = "20260815-road-feeders-v32"
ATLAS_VERSION = "v32"
...
def main() -> None:
    ...
    report_path = Path("/tmp/north-wildwood-bunny-v32-upload.json")
