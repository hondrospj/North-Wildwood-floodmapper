...
assert.match(SOURCE, /20260811-hydraulic-v25-bunny/);
assert.match(SOURCE, /floodmapperv1\.b-cdn\.net\/DepthPNGs\/North%20Wildwood\/crest\//);
assert.match(SOURCE, /floodmapperv1\.b-cdn\.net\/COGs\/North%20Wildwood\/v25\/NorthWildwoodHydraulicStates\.json\.png/);
