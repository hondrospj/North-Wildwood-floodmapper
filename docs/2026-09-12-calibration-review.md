...
Original USGS responses, request URLs, retrieval times, hashes, and agency qualifiers were retained in the local backfill audit. The overlapping response chunks contain 549 estimated-value flags and one revised-record flag; approved and provisional status remain distinguishable in those source responses. Compact M/I flags describe exact timestamps and short interpolation, not agency approval or independent instrument calibration. The calibrated Sandy and Jonas replays remain separately marked C and excluded from continuous exposure and trend fits. Sandy retains its existing Lewes tide shape and official 6.73-ft NAVD88 Stone Harbor crest, with Lewes identified as the shape source. The raw Stone Harbor Sandy outage remains missing in the station-only archive. A full source rebuild now reapplies that documented replay to the public composite and its hourly/year-shard companions.
