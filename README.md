...
1. Rasterizes the user-drawn bulkhead centerline with GDAL, expands it two
   one-foot cells on both sides (five cells nominal width), and stitches that
...
./north_wildwood_hydraulic_graph \
  --dem /path/to/NorthWildwoodDEM_Bulkhead5Cell_1ft_NAVD88.tif \
  --source /path/to/source_blocks_1ft.tif \
  --hard /path/to/bulkheads_5cell_1ft.tif \
...
The feature validator fails if the centerline is not expanded by at least two
...
4. source-block flag;
5. five-cell, 7.5-foot bulkhead flag;
